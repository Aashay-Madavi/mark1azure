...
from .views import AddTrack, FetchOrderTrack, UpdateOrderTrack, DeleteOrderTrack, FetchAllOrderTrack, DeleteAllOrderTrack
urlpatterns = [
    ...
    path('deleteAll/', DeleteAllOrderTrack.as_view())
]
